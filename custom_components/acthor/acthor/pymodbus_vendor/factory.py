...
from .bit_read_message import *
from .bit_write_message import *
from .compat import byte2int
from .diag_message import *
from .exceptions import MessageRegisterException, ModbusException
from .file_message import *
from .interfaces import IModbusDecoder
from .mei_message import *
from .other_message import *
from .pdu import ExceptionResponse, IllegalFunctionRequest, ModbusExceptions as ecode, ModbusRequest, ModbusResponse
from .register_read_message import *
from .register_write_message import *
    ...
    def register(self, function=None):
        ...
        if function and not issubclass(function, ModbusRequest):
            raise MessageRegisterException("'{}' is Not a valid Modbus Message"
                                           ...
                                           "`pymodbus_vendor.pdu.ModbusRequest` "
                                           "".format(
...
class ClientDecoder(IModbusDecoder):
    ...
    def register(self, function=None, sub_function=None, force=False):
        ...
        if function and not issubclass(function, ModbusResponse):
            raise MessageRegisterException("'{}' is Not a valid Modbus Message"
                                           ". Class needs to be derived from "
                                           "`pymodbus_vendor.pdu.ModbusResponse` "
                                           "".format(
                function.__class__.__name__
            ))
        self.__lookup[function.function_code] = function
